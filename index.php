...
.chart-live-dot {
    ...
    animation: livePulse 2s infinite; box-shadow: 0 0 6px rgba(16,185,129,0.4);
}
.chart-live-text {
...
/* Filter inputs */
.chart-filter-input {
    max-width: 125px; height: 28px; font-size: 0.65rem; font-weight: 600;
    border: 1px solid var(--chart-metric-border); border-radius: 8px;
    background: var(--chart-wrap-bg); color: var(--text-primary);
    padding: 0 0.5rem; outline: none; transition: border-color 0.2s;
}
.chart-filter-input:focus { border-color: var(--primary-color); }

/* View toggle pill bar */
.chart-view-toggle {
    display: flex; align-items: center; gap: 1px;
    background: var(--chart-wrap-bg); padding: 2px; border-radius: 8px;
    border: 1px solid var(--chart-metric-border);
}
.btn-view-toggle {
    padding: 0.25rem 0.5rem; border: none; background: transparent;
    color: var(--text-muted); border-radius: 6px; font-size: 0.62rem;
...
.btn-view-toggle:not(.active):hover {
    background: var(--chart-metric-bg); color: var(--text-primary);
}
...
.chart-badge {
    ...
    padding: 0.08rem 0.35rem; border-radius: 4px; font-size: 0.55rem; font-weight: 700;
    flex-shrink: 0;
}
.chart-badge-up { background: rgba(16,185,129,0.1); color: #10b981; }
.chart-badge-down { background: rgba(239,68,68,0.1); color: #ef4444; }
...
.chart-legend-line {
    width: 12px; height: 2.5px; border-radius: 2px; flex-shrink: 0;
}
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            <div style="width: 32px; height: 32px; background: #f8fafc; border-radius: 8px; display: flex; align-items: center; justify-content: center; border: 1px solid #e2e8f0;">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><path d="m12 1v2m0 18v2m4.22-18.36 1.42 1.42M4.93 19.07l1.41 1.42m12.73 0 1.41-1.42M4.93 4.93l1.42 1.42M1 12h2m18 0h2"/></svg>
            </div>
            <div>
        ...
        <div style="background: #fff; border-radius: 10px; padding: 14px; border: 1px solid #e2e8f0;">
            <h3 style="font-size: 12px; font-weight: 600; color: #1e293b; margin-bottom: 12px; display: flex; align-items: center; gap: 8px;">
                <span style="width: 24px; height: 24px; background: #f8fafc; border-radius: 6px; display: flex; align-items: center; justify-content: center; border: 1px solid #e2e8f0;">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#64748b" stroke-width="2"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>
                </span>
                Distribusi Budget
            </h3>
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    titleFont: { size: 10, weight: '500', family: "'Inter', sans-serif" },
