<?php
// Update menus - standalone script
$host = 'localhost';
$user = 'root';
$pass = '';
$dbname = 'adf_system';
...
try {
    ...
    foreach ($businesses as $biz) {
        ...
        echo "OK Assigned all menus to {$biz['business_name']}\n";
    }
    
    echo "\nOK Menu assignment complete!\n\n";
    ...
    foreach ($businesses as $biz) {
        ...
        echo "OK Full permissions granted for {$biz['business_name']}\n";
    }
