...
echo "<h2>Test Project Module Access</h2>";
echo "<pre>";
...
$hasProject = $auth->hasPermission('project');
echo "hasPermission('project'): " . ($hasProject ? "✓ YES" : "✗ NO") . "\n\n";
...
if (!$auth->isLoggedIn()) {
    ...
    try {
        ...
        echo "Table 'projects': " . ($tableExists ? "✓ EXISTS" : "✗ NOT FOUND") . "\n";
        
        if (!$tableExists) {
            echo "\n⚠️ WARNING: Table 'projects' tidak ada!\n";
...
echo "</pre>";
echo "<hr>";
echo "<a href='index.php'>Try Access Project Module</a> | ";
