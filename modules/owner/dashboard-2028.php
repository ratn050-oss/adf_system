...
// ============================================
// CALENDAR DATA - Rooms & Bookings for hotel businesses
// ============================================
$calRooms = [];
$calBookings = [];
$calRoomsByType = [];
...
if (!$error) {
    try {
        ...
        // Calendar data optional - don't break dashboard
        $hasCalendar = false;
    }
}
...
<head>
    ...
    <style>
        * {
        ...
        /* ══════════════════════════════════════════ */
        /* OWNER CALENDAR - Booking Overview          */
        /* ══════════════════════════════════════════ */
        .ocal-section {
            margin: 16px 0;
            background: #ffffff;
                    ...
                    <div class="ocal-grid-wrapper">
                        <div class="ocal-grid" style="grid-template-columns: 90px repeat(<?= $totalCols ?>, <?= $colW ?>px);">
                            ...
                            <div class="ocal-date-cell<?= $isToday ? ' today' : '' ?>" data-date="<?= $d ?>">
                                <?php
                                // Render booking bar only on check-in date
