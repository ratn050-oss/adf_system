            ...
            <div style="display: flex; align-items: center; gap: 1.5rem;">
                ...
                <div style="position: relative; width: 120px; height: 120px; flex-shrink: 0;">
                    ...
                    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
                        <div id="occupancyPercent" style="font-size: 1.25rem; font-weight: 800; color: #1e3a8a;">0%</div>
                        <div style="font-size: 0.6rem; color: #6b7280;">Occupancy</div>
                    </div>
                </div>
                
                <!-- Stats -->
                <div style="flex: 1; display: flex; flex-direction: column; gap: 0.5rem;">
                    <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.5rem 0.75rem; background: #f0fdf4; border-radius: 8px;">
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <span style="width: 10px; height: 10px; background: #10b981; border-radius: 50%;"></span>
                            <span style="font-size: 0.75rem; color: #374151;">Booked</span>
                        </div>
                        <span id="occupiedRooms" style="font-size: 0.85rem; font-weight: 700; color: #166534;">0</span>
                    </div>
                    <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.5rem 0.75rem; background: #f3f4f6; border-radius: 8px;">
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <span style="width: 10px; height: 10px; background: #e5e7eb; border-radius: 50%;"></span>
                            <span style="font-size: 0.75rem; color: #374151;">Available</span>
                        </div>
                        <span id="availableRooms" style="font-size: 0.85rem; font-weight: 700; color: #374151;">0</span>
                    </div>
                    <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.5rem 0.75rem; background: #fef3c7; border-radius: 8px;">
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <span style="width: 10px; height: 10px; background: #f59e0b; border-radius: 50%;"></span>
                            <span style="font-size: 0.75rem; color: #374151;">Maintenance</span>
                        </div>
                        <span id="maintenanceRooms" style="font-size: 0.85rem; font-weight: 700; color: #92400e;">0</span>
                    </div>
                    <div style="text-align: center; font-size: 0.65rem; color: #9ca3af; margin-top: 0.25rem;">
                        Total: <span id="totalRooms">0</span> rooms
                    </div>
                </div>
            </div>
        </div>
